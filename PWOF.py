...
import time
# import sys
# sys.setExecutionLimit(600000) uncomment this to run the code in browser
...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(self, category, obscurePhrase, guessed):
        player_prompt = input(self.name + "has $" + str(self.prizeMoney) + "\n" + "Category:" + category + "\n" + "Phrases:" +
                              "\n" + ' '.join([str(elem) for elem in obscurePhrase]) + "\n" + "Guessed:" + ' '.join([str(elem) for elem in guessed]) + "\n" + "Guess a letter, phrase, or type 'exit' or 'pass':")
